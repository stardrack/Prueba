class ComentariosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to comentarios_path, status: :see_other, notice: "Comentario was successfully destroyed." }
  ...
  private
    ...
    def comentario_params
      params.require(:comentario).permit(:contedido, :usuario_id, :articulo_id)
    end
end
